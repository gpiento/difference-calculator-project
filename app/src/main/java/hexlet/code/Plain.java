...
public class Plain {
    ...
    public static String render(Map<String, Object> mapReadValue1, Map<String, Object> mapReadValue2) {
        ...
        for (Map.Entry<String, Object> entry : commonMap.entrySet()) {
            ...
            if (value1 == null) {
                diff.append(String.format("Property '%s' was added with value: %s%n", key, value2));
            } else if (value2 == null) {
                diff.append(String.format("Property '%s' was removed%n", key));
            } else if (!value1.equals(value2)) {
                diff.append(String.format("Property '%s' was updated. From '%s' to '%s'%n", key, value1, value2));
            }
        }
        diff.append("}\n");
